...
ScriptExtender_PotionDB = {
    ...
    HEALTH = {
        ...
        { name = "Greater Healthstone",     min = 800,  max = 800,  type = "Healthstone" },
        ...
        { name = "Greater Healing Potion",  min = 455,  max = 585,  type = "Potion" },
    ...
    MANA = {
        ...
        { name = "Greater Mana Potion",   min = 700,  max = 900,  type = "Potion" }, -- Avg 800
